...
bool PanelLayer::init()
{
	...
	_goldCounter->setPosition(ccp(595, 18));

	ScheduleCountDown* countDown = ScheduleCountDown::create(this);

	_scheduleLabel = CCLabelTTF::create("70", "Thonburi", 60);
	_scheduleLabel->setColor(ccc3(255,0,255));
	_scheduleLabel->addChild(countDown);
	this->addChild(_scheduleLabel);
	_scheduleLabel->setPosition(ccp(499, 23));
