...
bool GameMenuLayer::init()
{
	do 
	{
		...
		titleSprite->setPosition(ccp(winSize.width/2, winSize.height * 0.4));
...
void GameMenuLayer::createMenu(void)
{
	...
	startNormalTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 18));
	...
	startSelectedTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 18));
